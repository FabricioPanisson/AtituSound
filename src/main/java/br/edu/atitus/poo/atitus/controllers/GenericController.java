...
@ApiResponses(value = {
	@ApiResponse(responseCode = "400", description = "Erro de validacao ou requisicao invalida",
			content = @Content, headers = @Header(name = "error", description = "descricao do erro", schema = @Schema(implementation = String.class))),
